...
public class CRUD_CDR extends JFrame {
	...
	public CRUD_CDR() {
		...
		JLabel lblNewLabel = new JLabel("Nombre de CDR");
		lblNewLabel.setBounds(10, 40, 102, 14);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Nombre del Presidente");
		...
		table = new JTable();
		table.setBounds(10, 118, 291, 301);
			...
			public void actionPerformed(ActionEvent e) {
				try{
					if(!textField.getText().equals("") && !textField_1.getText().equals("") && table_2.getSelectedRow()!=-1){
						CDR_service.Create(textField.getText(),textField_1.getText(),Colegio_service.ReadAll().get(table_2.getSelectedRow()).getId());
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(!textField.getText().equals("") && !textField_1.getText().equals("") && table_2.getSelectedRow()!=-1){
					if(table.getSelectedRow()!=-1){
						CDR_service.Update(textField.getText(),textField_1.getText(),Colegio_service.ReadAll().get(table_2.getSelectedRow()).getId(),CDR_service.ReadAll().get(table.getSelectedRow()).getId());
						refreshTable(table);
					}
				}
			}
		...
		JLabel lblNewLabel_4 = new JLabel("Elija el colegio al que pertenece");
		lblNewLabel_4.setBounds(462, 93, 218, 14);
		contentPane.add(lblNewLabel_4);
		
		table_2 = new JTable();
		table_2.setBounds(417, 118, 291, 301);
