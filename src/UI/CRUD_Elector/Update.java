...
public class Update extends JFrame {
	...
	public Update(int id) {
		...
		JLabel lblNewLabel_1 = new JLabel("Nuevo Nombre del Elector");
		...
		JLabel lblNewLabel_2 = new JLabel("Nuevos Apellidos");
		...
		JLabel lblNewLabel_3 = new JLabel("Re-Elija su fecha de nacimiento");
		lblNewLabel_3.setBounds(10, 167, 209, 14);
		contentPane.add(lblNewLabel_3);

		JLabel lblNewLabel_4 = new JLabel("Nueva Direccion particular");
			...
			public void mouseClicked(MouseEvent e) {
				try{
					if(!textField.getText().equals("") && !textField_1.getText().equals("") && table.getSelectedRow()!=-1){
						Elector_service.Update(id,textField.getText(),textField_1.getText(), (Date) calendar.getDate(),textField_2.getText(), CDR_service.ReadAll().get(table.getSelectedRow()).getId());
